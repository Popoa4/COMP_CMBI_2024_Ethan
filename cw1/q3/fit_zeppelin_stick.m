...
function [params_opt, resnorm] = fit_zeppelin_stick(meas, bvals, grad_dirs)
    ...
    min_resnorm = Inf;
    for i = 1:num_trials
        pert = [0.2*x0(1), 0.2*x0(2), 0.2*x0(3), 0.3*pi, pi, 0.5*x0(6)].*randn(1,6);
